#
# Be sure to run `pod lib lint TKAuthorityModule.podspec' to ensure this is a
...
TODO: about authority 
  ...
  s.source_files = 'TKAuthorityModule/Classes/**/*'
  
  # s.resource_bundles = {
  #   'TKAuthorityModule' => ['TKAuthorityModule/Assets/*.png']
  # }
